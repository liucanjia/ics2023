...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 100 ????? 01110 11", divw   , R, R(rd) = SEXT((int64_t)BITS(src1, 31, 0) / (int64_t)BITS(src2, 31, 0), 32));
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem    , R, R(rd) = (int64_t)src1 % (int64_t)src2);
  INSTPAT("0000001 ????? ????? 110 ????? 01110 11", remw   , R, R(rd) = SEXT((int64_t)BITS(src1, 31, 0) % (int64_t)BITS(src2, 31, 0), 32));
  ...
  INSTPAT("000000 ?????? ????? 101 ????? 01110 11", srlw   , R, R(rd) = BITS(src1, 31, 0) >> BITS(src2, 4, 0));
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 01110 11", sllw   , R, R(rd) = SEXT(BITS(src1, 31, 0), 32) << BITS(src2, 4, 0));
